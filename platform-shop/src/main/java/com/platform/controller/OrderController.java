...
public class OrderController {
    ...
    public R sendShip(@RequestBody OrderEntity order) {
        orderService.sendShip(order);
        return R.ok();
    }
    /**
     * 发货
    ...
    @RequiresPermissions("order:sendGoods")
    public R sendGoods(@RequestBody Integer id) {
    	OrderEntity order=orderService.queryObject(id);
    ...
    @RequiresPermissions("doPrint")
    public R doPrint(@RequestBody Integer[] ids) {
        //orderService.sendGoods(order);
