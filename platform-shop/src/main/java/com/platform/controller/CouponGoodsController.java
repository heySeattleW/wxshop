...
public class CouponGoodsController {
     ...
     * 查看所有列表
     */
    @RequestMapping("/selectAllCouponGoods")
    public R selectAllCouponGoods() {

        List<CouponGoodsEntity> list = couponGoodsService.selectAllCouponGoods();
     ...
     * 查看所有列表
     */
    @RequestMapping("/selectCouponGoods/{couponId}")
    public R selectCouponGoods(@PathVariable("couponId") Integer couponId) {

        List<CouponGoodsEntity> list = couponGoodsService.selectCouponGoods(couponId);
