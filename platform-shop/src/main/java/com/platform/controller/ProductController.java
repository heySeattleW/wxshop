...
public class ProductController {
    ...
    @RequestMapping("/querySpecification/{id}")
    public R querySpecification(@PathVariable("id") Integer id) {
    	List list=productService.querySpecification(id);
     ...
     */
    /*
    @RequestMapping("/queryAttribute/{id}")
    public R queryAttribute(@PathVariable("id") Integer id) {
    	List list=productService.queryAttribute(id);
    	return R.ok().put("list", list);
    }*/
