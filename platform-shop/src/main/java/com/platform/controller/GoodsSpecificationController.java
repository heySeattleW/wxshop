...
public class GoodsSpecificationController {
     ...
     * 查找商品的规格　
     */
    @RequestMapping("/querybyGoods/{goodId}")
    @RequiresPermissions("goodsspecification:list")
    public R querybygoods(@PathVariable("goodId") Integer goodId,@RequestParam Map<String, Object> params ) {
        //查询列表数据
    	 //查询列表数据
     ...
     * 查找商品的规格　
     */
    @RequestMapping("/queryAllbyGoods/{goodId}")
    public R queryAllbyGoods(@PathVariable("goodId") Integer goodId) {
        //查询列表数据
    	 //查询列表数据
