...
public class CouponEntity implements Serializable {
    ...
    private	 List<CouponGoodsEntity> couponGoodsList;
    private List<CouponGoodsEntity> delCouponGoodsList;

    
    public List<CouponGoodsEntity> getCouponGoodsList() {
		return couponGoodsList;
	}

	public void setCouponGoodsList(List<CouponGoodsEntity> couponGoodsList) {
		this.couponGoodsList = couponGoodsList;
	}

	public List<CouponGoodsEntity> getDelCouponGoodsList() {
		return delCouponGoodsList;
	}

	public void setDelCouponGoodsList(List<CouponGoodsEntity> delCouponGoodsList) {
		this.delCouponGoodsList = delCouponGoodsList;
	}
