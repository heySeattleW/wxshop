...
public class ApiRegionController extends ApiBaseAction {
    ...
    public Object listAll() {
        List<MyRegion> regionEntityList = RegionCacheUtil.getAll();
        
        return toResponsSuccess(regionEntityList);
    }
	
    @IgnoreAuth
    @GetMapping("listAllLevel")
    public Object listAllLevel() {
        List<MyRegion> regionEntityList = RegionCacheUtil.getAllLevel();
