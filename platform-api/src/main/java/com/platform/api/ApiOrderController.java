...
public class ApiOrderController extends ApiBaseAction {
    ...
    public Object list(@LoginUser UserVo loginUser,
        ...
        Integer[] order_statuss=null; 
        if(type==400) {
        	order_statuss=new Integer[2];
        	order_statuss[0]=401;
        	order_statuss[1]=402;
        	params.put("order_statuss", order_statuss);
        }else {
        	order_statuss=new Integer[1];
        	order_statuss[0]=type;
        	params.put("order_statuss", order_statuss);
        }
        params.put("sidx", "id");
    ...
    public Object cancelOrder(Integer orderId) {
        try {
        	if(orderId==null) {
        	 ...
        	 orderId = jsonParam.getIntValue("orderId");
        	}
    ...
    public Object confirmOrder(Integer orderId) {
        try {
        	if(orderId==null) {
	        	 ...
	        	 orderId =Integer.parseInt(jsonParams.getString("orderId"));
        	}
