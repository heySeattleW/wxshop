...
public class ApiGoodsService {
    ...
    public List<ActivityGoodsVo> queryActivityGoodsList() {
    	return goodsDao.queryActivityGoodsList();
    }
    public List<CouponGoodsVo> queryCouponoodsList(Map params) {
    	return goodsDao.queryCouponGoodsList(params);
    }
    public List<CouponGoodsVo> queryCouponoodsList(Integer userCouponId) {
    	return goodsDao.queryCouponGoodsListById(userCouponId);
    }
  
    public int queryCouponoodsTotal(Map<String, Object> map) {
        return goodsDao.queryCouponoodsTotal(map);
    }
    public List<GoodsVo> queryList(Map<String, Object> map) {
        return goodsDao.queryList(map);
    }

    public List<GoodsVo> queryTimeGoodsList(Map<String, Object> map) {
        return goodsDao.queryTimeGoodsList(map);
    }
