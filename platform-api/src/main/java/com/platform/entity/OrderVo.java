...
public class OrderVo implements Serializable {
    ...
    3xx 表示订单物流相关状态　300订单已发货， 301用户待评价 302 已评价
    ...
    */
    ...
    private Integer pickUpType;//取货方式
    
    private Integer isDdzt; //取货方式
    
    
    public Integer getIsDdzt() {
    	isDdzt=pickUpType;
		return isDdzt;
	}

	public void setIsDdzt(Integer isDdzt) {
		this.isDdzt = isDdzt;
	}
    ...
    public Map getHandleOption() {
        ...
        handleOption.put("return", false); //申请退款
