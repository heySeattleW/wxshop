...
public class CouponVo implements Serializable {
    ...
    private Map<Integer ,CouponGoodsVo> couponGoodsVoMap;
    

    public Map<Integer, CouponGoodsVo> getCouponGoodsVoMap() {
    	if(couponGoodsVoMap==null) {
    		couponGoodsVoMap=new HashMap();
    	}
		return couponGoodsVoMap;
	}

	public void setCouponGoodsVoMap(Map<Integer, CouponGoodsVo> couponGoodsVoMap) {
		this.couponGoodsVoMap = couponGoodsVoMap;
	}

	public List<CouponGoodsVo> getCouponGoodsVoList() {
		return couponGoodsVoList;
	}

	public void setCouponGoodsVoList(List<CouponGoodsVo> couponGoodsVoList) {
		this.couponGoodsVoList = couponGoodsVoList;
	}
