...
public class GoodsVo implements Serializable {
    ...
    //限时购
    private Integer is_timelimited;
    //热销
	...
	public Integer getIs_timelimited() {
		return is_timelimited;
	}

	public void setIs_timelimited(Integer is_timelimited) {
		this.is_timelimited = is_timelimited;
	}
