...
public class WechatUtil {
     ...
     * @return
     */
    public static String arrayShaSign(Map<Object, Object> params, String paySignKey) {
        boolean encode = false;
        Set<Object> keysSet = params.keySet();
        Object[] keys = keysSet.toArray();
        Arrays.sort(keys);
        ...
        temp.append(paySignKey);
        System.out.println(temp.toString());
        String packageSign = SHA1.getMessageDigest(temp.toString());
     ...
     * @throws Exception
     */
    public static byte[] requestImage(final String url, Map<String, Object> params ) throws Exception {
    	 HttpPost httpPost = new HttpPost(url);
    	 logger.info("url="+url);
         ...
         String reusltObj = EntityUtils.toString(response.getEntity(), "UTF-8");
         logger.info("请求结果:" + reusltObj);
