...
public class QcloudCloudStorageService extends CloudStorageService {
	...
	private void init() {
	 ...
	 public String localupload(InputStream inputStream, String fileName) {
	        try {
	        	
	             String prefix = fileName.substring(fileName.lastIndexOf(".") + 1);
	             String path=getPath(config.getQcloudPrefix()) + "." + prefix;
	 ...
	 @Override
	    public String upload(byte[] data) throws Exception {
	        ...
	        //String prefix = fileName.substring(fileName.lastIndexOf(".") + 1);
	        return upload(data, getPath(config.getAliyunPrefix()) + ".jpg" );
	    }
	@Override
